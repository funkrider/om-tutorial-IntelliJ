...
var self__ = this;
var this$ = this;
var x_SINGLEQUOTE__19882 = cljs.core.vary_meta.call(null,x,cljs.core.assoc,new cljs.core.Keyword(null,"client-time","client-time",-1212214195),(new Date()));
if((self__.size <= self__.arr.length)){
var id_SINGLEQUOTE__19883 = self__.arr.shift();
cljs.core.swap_BANG_.call(null,self__.index,((function (id_SINGLEQUOTE__19883,x_SINGLEQUOTE__19882,this$){
return (function (p1__19881_SHARP_){
return cljs.core.assoc.call(null,cljs.core.dissoc.call(null,p1__19881_SHARP_,id_SINGLEQUOTE__19883),id,x_SINGLEQUOTE__19882);
});})(id_SINGLEQUOTE__19883,x_SINGLEQUOTE__19882,this$))
);
} else {
cljs.core.swap_BANG_.call(null,self__.index,cljs.core.assoc,id,x_SINGLEQUOTE__19882);
}
...
om.next.cache.Cache.cljs$lang$ctorPrWriter = (function (this__19224__auto__,writer__19225__auto__,opt__19226__auto__){
return cljs.core._write.call(null,writer__19225__auto__,"om.next.cache/Cache");
});
